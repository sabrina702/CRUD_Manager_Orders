...
<body>
	...
	<div id="container" class="container-fluid">
		<h3 class="page-header">${action eq "insert" ? "Adicionar" : "Editar"} Empresa</h3>
		
		<form action="${pageContext.request.contextPath}/company/${action}" 
			method="POST">
			
			<input type="hidden" value="${companies.getId()}" name="companyId">
			...
			<div class="row">
				<div class="form-group col-md-6">
					...
					<input type="text" class="form-control" id="name" name="name" 
						   ...
						   oninput="setCustomValidity('')"  value="${companies.getName()}" />
				</div>
				...
				<div class="form-group col-md-6">
					...
					<input type="text" class="form-control" id="role" name="role" 
						   ...
						   oninput="setCustomValidity('')"   value="${companies.getRole()}"/>
				</div>				
			</div>
			...
			<div class="row">
				<div class="form-group col-md-4">
					...
					<input type="date" class="form-control" id="start" name="start" 
						   ...
						   oninput="setCustomValidity('')"  value="${companies.getStart()}" />
				</div>
				...
				<div class="form-group col-md-4">
					...
					<input type="date" class="form-control" id="end" name="end" 
						   ...
						   oninput="setCustomValidity('')"  value="${companies.getEnd()}" />
				</div>
			...
			<div id="actions" class="row pull-right">
				<div class="col-md-12">
					...
					<button type="submit" 
						    class="btn btn-primary">${action eq "insert" ? "Adicionar" : "Editar"} Empresa</button>
				</div>
			</div>
		</form>
